...
public class HorizontalScrollList extends FrameLayout {
	/**
	 * width of child
	 */
	...
	public HorizontalScrollList(Context context, AttributeSet attrs, int defStyle) {
...
//		this.getChildAt(currentChildIndex).requestFocusFromTouch();
	...
	private boolean update(){
		...
		for(int i = 0;i<childNum;i++){
			...
			params.leftMargin = i*(childWidth-rightOverlap+gap);
	...
	private void scroll(int num){
		...
		//Toast.makeText(mContext, "index--"+visibleChildIndex, Toast.LENGTH_SHORT).show();
		mScroller.startScroll(startX, startY, (childWidth-rightOverlap+gap)*num,0, (int)(1000*animationTime/*Math.abs(num)*/));
		isMoving = true;
