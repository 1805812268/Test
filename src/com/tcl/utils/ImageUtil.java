...
public class ImageUtil {
	...
	public static List<Bitmap> getBitmapFormURL(List<String> imageUrls,int type,int newWidth,int newHeight){
		...
		for(int i=0;i<imageUrls.size();i++){
			...
			bms.add(getBitmapFormURL(imageUrl,type,newWidth,newHeight));
		}
		return bms;
   }   
